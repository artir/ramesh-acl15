...
class Unsupervised{
	public static void main(String[] args)
	{
		...
		for(int i = 0; i <10; ++i)
		{
			Unsupervised a = new Unsupervised()
...
//		modelfile.append("\n")
		...
		DataOutputter.outputClassificationPredictions("output" + "/unsupervised/results/finetopic.txt",
				trainDB, finetopic_1, "\t")
		...
		File outputstats = new File("output/unsupervised/pslsentimentsigstats.txt")
...
outputstats.append("end"+"\n")
		...
		File outputstats_fine = new File("output/unsupervised/pslfinesigstats.txt")
		println stats.getAccuracy()
		...
		outputstats_fine.append( stats.getF1(6)+"\n")
		outputstats_fine.append( stats.getPrecision(6)+"\n")
		outputstats_fine.append( stats.getRecall(6)+"\n")
		...
		outputstats_fine.append(stats.getF1(8)+"\n")
		outputstats_fine.append(stats.getPrecision(8)+"\n")
		outputstats_fine.append(stats.getRecall(8)+"\n")
		
		
		outputstats_fine.append( stats.getF1(10)+"\n")
		outputstats_fine.append(stats.getPrecision(10)+"\n")
		outputstats_fine.append( stats.getRecall(10)+"\n")
		
		outputstats_fine.append(stats.getF1(7)+"\n")
		outputstats_fine.append(stats.getPrecision(7)+"\n")
		outputstats_fine.append(stats.getRecall(7)+"\n")

		

		outputstats_fine.append(stats.getF1(9)+"\n")
		outputstats_fine.append(stats.getPrecision(9)+"\n")
		outputstats_fine.append(stats.getRecall(9)+"\n")

		

		outputstats_fine.append( stats.getF1(11)+"\n")
		outputstats_fine.append(stats.getPrecision(11)+"\n")
		outputstats_fine.append( stats.getRecall(11)+"\n")
		
		outputstats_fine.append( stats.getF1(13)+"\n")
		outputstats_fine.append( stats.getPrecision(13)+"\n")
		outputstats_fine.append(stats.getRecall(13)+"\n")
		
		outputstats_fine.append( stats.getF1(12)+"\n")
		outputstats_fine.append(  stats.getPrecision(12)+"\n")
		outputstats_fine.append(stats.getRecall(12)+"\n")

		

		outputstats_fine.append(  stats.getF1(14)+"\n")
		outputstats_fine.append( stats.getPrecision(14)+"\n")
		outputstats_fine.append( stats.getRecall(14)+"\n")
