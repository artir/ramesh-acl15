...
//m.add rule : (post(P) & ~seedldacoarse(P, data.getUniqueID(1)) & ~seedldacoarse(P, data.getUniqueID(2)) & ~seedldacoarse(P, data.getUniqueID(3)) & ~seedldacoarse(P, data.getUniqueID(4)) & ~seedldacoarse(P, data.getUniqueID(5)))	>>	coarsetopic(P, data.getUniqueID(6)), weight : 5, squared:true
//m.add rule : (post(P) & ~seedldacoarse(P, data.getUniqueID(2)) & ~seedldacoarse(P, data.getUniqueID(3)) & ~seedldacoarse(P, data.getUniqueID(4)) & ~seedldacoarse(P, data.getUniqueID(5)) & ~seedldacoarse(P, data.getUniqueID(6)))	>>	coarsetopic(P, data.getUniqueID(1)), weight : 5, squared:true
//
//
...
//m.add rule : (seedldacoarse(P, data.getUniqueID(1)) & coarsetopic(P, data.getUniqueID(1)))	>>	sentiment_1(P, data.getUniqueID(1)), weight : 10, squared:true
//m.add rule : (seedldacoarse(P, data.getUniqueID(2)) & coarsetopic(P, data.getUniqueID(2)))	>>	sentiment_1(P, data.getUniqueID(1)), weight : 10, squared:true
//m.add rule : (seedldacoarse(P, data.getUniqueID(3)) & coarsetopic(P, data.getUniqueID(3))) >> sentiment_1(P, data.getUniqueID(1)), weight : 10, squared:true
//m.add rule : (seedldacoarse(P, data.getUniqueID(4)) & coarsetopic(P, data.getUniqueID(4))) >> sentiment_1(P, data.getUniqueID(1)), weight : 10, squared:true
//m.add rule : (seedldacoarse(P, data.getUniqueID(5)) & coarsetopic(P, data.getUniqueID(5))) >> sentiment_1(P, data.getUniqueID(1)), weight : 10, squared:true
//m.add rule : (seedldacoarse(P, data.getUniqueID(6)) & coarsetopic(P, data.getUniqueID(6))) >> sentiment_1(P, data.getUniqueID(2)), weight : 10, squared:true
//m.add rule : (seedldacoarse(P, data.getUniqueID(6)) & coarsetopic(P, data.getUniqueID(6))) >> sentiment_1(P, data.getUniqueID(3)), weight : 10, squared:true


//Sentiment : 1 - positive, 2 - negative, 3 - neutral

//m.add rule : (sentimentseeded_1(P) ) >> coarsetopic(P, data.getUniqueID(6)), weight : 5, squared:true
//m.add rule : (sentimentseeded_2(P)) >> coarsetopic(P, data.getUniqueID(1)), weight : 5, squared:true
//m.add rule : (sentimentseeded_2(P)) >> coarsetopic(P, data.getUniqueID(2)), weight : 5, squared:true
//m.add rule : (sentimentseeded_2(P)) >> coarsetopic(P, data.getUniqueID(3)), weight : 5, squared:true
//m.add rule : (sentimentseeded_2(P)) >> coarsetopic(P, data.getUniqueID(4)), weight : 5, squared:true
//m.add rule : (sentimentseeded_2(P)) >> coarsetopic(P, data.getUniqueID(5)), weight : 5, squared:true
//m.add rule : (sentimentseeded_3(P)) >> coarsetopic(P, data.getUniqueID(6)), weight : 5, squared:true
...
//m.add rule : (coarsetopic(P1, C) & thread(P1, T) & course(P1, C1) & thread(P2, T) & course(P2, C1)) >> coarsetopic(P2, C), weight : 10, squared:true
...
{
	String filepath1 = filename+p.getName().toString().toLowerCase()+".txt"
	println "\t\t\tREADING " + p.getName() +" from "+filepath1+"...";
	InserterUtils.loadDelimitedData(data.getInserter(p, trainPartition.get(cvSet)),
			filepath1,"\t");
		...
		Set toClose = [fineseeded_1, fineseeded_2, fineseeded_3, fineseeded_4, fineseeded_5, fineseeded_6, fineseeded_7,
			...
			wekasentiment_1,wekasentiment_2,wekasentiment_3,sentimentseeded3_max, thread, course] as Set;
...
//		File outputstats = new File("output/unsupervised/pslsentimentsigstats1.txt")
...
//		outputstats.append( stats.getF1(0)+"\n")
//		outputstats.append( stats.getPrecision(0)+"\n")
//		outputstats.append( stats.getRecall(0)+"\n")
//
//		outputstats.append( stats.getF1(1)+"\n")
//		outputstats.append( stats.getPrecision(1)+"\n")
//		outputstats.append( stats.getRecall(1)+"\n")
//		
//		outputstats.append( stats.getF1(2)+"\n")
//		outputstats.append( stats.getPrecision(2)+"\n")
//		outputstats.append(stats.getRecall(2)+"\n")
//		
		...
		File outputstats_fine = new File("output/unsupervised/pslcoarsesigstats.txt")
		println stats.getAccuracy()
