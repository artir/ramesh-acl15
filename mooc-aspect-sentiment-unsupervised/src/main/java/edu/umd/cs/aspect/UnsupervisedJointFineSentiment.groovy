...
m.add rule : (fineseeded_11(P) & coarsetopic(P, data.getUniqueID(3))) >> sentiment_1(P, data.getUniqueID(3)), weight : 10, squared:true
m.add rule : (fineseeded_12(P) & coarsetopic(P, data.getUniqueID(4))) >> sentiment_1(P, data.getUniqueID(3)), weight : 10, squared:true
m.add rule : (fineseeded_13(P) & coarsetopic(P, data.getUniqueID(5))) >> sentiment_1(P, data.getUniqueID(3)), weight : 10, squared:true
...
//fine2seeded -> finetopic
m.add rule : (fine2_seeded_1(P) & lecture_sum(P)) >> finetopic_1(P, data.getUniqueID(3)), weight : 5, squared:true
m.add rule : (fine2_seeded_2(P) & quiz_sum(P)) >> finetopic_1(P, data.getUniqueID(7)), weight : 5, squared:true
m.add rule : (fine2_seeded_3(P) & quiz_sum(P)) >> finetopic_1(P, data.getUniqueID(11)), weight : 5, squared:true
...
m.add rule : (fine2_seeded_5(P) & lecture_sum(P)) >> finetopic_1(P, data.getUniqueID(4)), weight : 5, squared:true
m.add rule : (fine2_seeded_5(P) & quiz_sum(P)) >> finetopic_1(P, data.getUniqueID(9)), weight : 5, squared:true
...
InserterUtils.loadDelimitedData(data.getInserter(coarsetopic, trainLabelsPartition.get(cvSet)),
	coarsetopicpath);
		...
		Set toClose = [fineseeded_1, fineseeded_2, fineseeded_3, fineseeded_4, fineseeded_5, fineseeded_6, fineseeded_7,
			...
			wekasentiment_1,wekasentiment_2,wekasentiment_3,sentimentseeded3_max, lecture_sum, quiz_sum] as Set;

		Database trainDB = data.getDatabase(trainPartition.get(cvSet), toClose as Set);
		Database trainLabelsDB = data.getDatabase(trainLabelsPartition.get(cvSet), [finetopic_1, coarsetopic,sentiment_1] as Set);
...
//		modelfile.append("\n")
		...
		trainLabelsDB.close()
		def groundTruthDB = data.getDatabase(trainLabelsPartition.get(cvSet), [coarsetopic, finetopic_1, sentiment_1] as Set)
		...
		DataOutputter.outputClassificationPredictions("output" + "/unsupervised/results/coarsetopic.txt",
				trainDB, coarsetopic, "\t")
		DataOutputter.outputClassificationPredictions("output" + "/unsupervised/results/sentiment.txt",
			trainDB, sentiment_1, "\t")
...
outputstats_fine.append("end"+"\n")
		...
		File outputstats_coarse = new File("output/unsupervised/coarse.txt")
		println stats.getAccuracy()
		
		outputstats_coarse.append("joint coarse sentiment")
		println "confusion matrix"+ stats.getConfusionMatrix()
		println "f1 for fientopic " + stats.getF1()
		outputstats_coarse.append(  "f1 for finetopic " + stats.getF1())
		outputstats_coarse.append(  "confusion matrix"+ stats.getConfusionMatrix()+"\n")
		outputstats_coarse.append( "f1 for fientopic 0 " + stats.getF1(0)+"\n")
		outputstats_coarse.append( "precision for fientopic 0 " + stats.getPrecision(0)+"\n")
		outputstats_coarse.append( "recall for fientopic 0 " + stats.getRecall(0)+"\n")

		outputstats_coarse.append( "f1 for fientopic 1 " + stats.getF1(1)+"\n")
		outputstats_coarse.append( "precision for fientopic 1 " + stats.getPrecision(1)+"\n")
		outputstats_coarse.append( "recall for fientopic 1 " + stats.getRecall(1)+"\n")

		outputstats_coarse.append( "f1 for fientopic (2) " + stats.getF1(2)+"\n")
		outputstats_coarse.append( "precision for fientopic (2) " + stats.getPrecision(2)+"\n")
		outputstats_coarse.append( "recall for fientopic (2) " + stats.getRecall(2)+"\n")

		outputstats_coarse.append( "f1 for fientopic (3) " + stats.getF1(3)+"\n")
		outputstats_coarse.append( "precision for fientopic (3) " + stats.getPrecision(3)+"\n")
		outputstats_coarse.append( "recall for fientopic (3) " + stats.getRecall(3)+"\n")

		outputstats_coarse.append( "f1 for finetopic_1 (4) " + stats.getF1(4)+"\n")
		outputstats_coarse.append( "precision for finetopic_1 (4) " + stats.getPrecision(4)+"\n")
		outputstats_coarse.append( "recall for finetopic_1 (4) " + stats.getRecall(4)+"\n")

		outputstats_coarse.append( "f1 for finetopic_1 (5) " + stats.getF1(5)+"\n")
		outputstats_coarse.append( "precision for finetopic_1 (5) " + stats.getPrecision(5)+"\n")
		outputstats_coarse.append( "recall for finetopic_1 (5) " + stats.getRecall(5)+"\n")
		...
		File outputstats_fine = new File("output/unsupervised/fine.txt")
		println stats.getAccuracy()
		
		outputstats_fine.append("joint coarse fine and sentiment")
		println "confusion matrix"+ stats.getConfusionMatrix()
		println "f1 for fientopic " + stats.getF1()
