...
//Predicates
		...
		m.add rule : relevancepred(P) >> finetopic(P, data.getUniqueID(0),data.getUniqueID(0)), weight : 5, squared:true
		...
		m.addKernel(new DomainRangeConstraintKernel21(finetopic,DomainRangeConstraintType.Functional))
